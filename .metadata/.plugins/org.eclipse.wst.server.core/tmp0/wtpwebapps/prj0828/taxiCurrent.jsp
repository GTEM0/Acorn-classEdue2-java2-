...
<link href = "./css/taxiCurrent.css" rel = "stylesheet"/>
...
<tr>
	...
	<td><a href = "taxi_UpdateForm.jsp?regno=<%=rs.getString(2)%>">수정</a>
			<a href = "taxiDelete_action.jsp?regno=<%=rs.getString(2)%>">삭제</a></td>
