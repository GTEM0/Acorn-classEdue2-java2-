...
<body>
    ...
    <tr>
        ...
        <td class="tdTitle"><a href="<%= request.getContextPath() %>/question?questionCode=<%= b.getQuestionCode() %>"><%= b.getTitle() %></a></td>
        <td class="tdId"><%= b.getBuyerId() %></td>
        <td><%= b.getWriteDate() %></td>
    </tr>
					<tr>
						<td>내용</td>
						<td><%=b.getQuestionContents()%></td>
					</tr>
					<%
					}
					%>
